...
(function () {
  ...
  function init() {
    ...
    // Instant 0ms startup: procedural head & interactive markers are ready immediately!
    ...
    // Show non-blocking sleek mini status for high-res model background loader
    if (loadingOverlay) {
  ...
  function setupControls() {
    ...
    // Smooth touch interaction configuration
    controls.touches = {
  ...
  // --- Robust 3D Model Loader with Auto-Fallback & Storage Cache ---
